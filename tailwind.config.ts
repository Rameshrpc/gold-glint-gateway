  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 0 0 hsl(var(--gradient-primary-start) / 0.4)" },
          "50%": { boxShadow: "0 0 0 8px hsl(var(--gradient-primary-start) / 0)" },
        },
        shimmer: {
        ...
        "pill-slide": {
          "0%": { transform: "translateX(var(--pill-from))" },
          "100%": { transform: "translateX(var(--pill-to))" },
        },
        "icon-pop": {
          "0%": { transform: "scale(1)" },
