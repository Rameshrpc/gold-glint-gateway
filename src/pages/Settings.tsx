...
export default function Settings() {
  ...
  const fetchUsers = async () => {
    ...
    try {
      ...
      // Filter by client if not platform admin
  ...
  const fetchClients = async () => {
    ...
    try {
      ...
      // Count enabled modules for each client
    ...
    <DashboardLayout>
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">Manage user rights and client modules</p>
        </div>

        <Tabs defaultValue="user-rights" className="space-y-4">
          <TabsList>
            <TabsTrigger value="user-rights" className="gap-2">
          ...
          <TabsContent value="user-rights" className="space-y-4">
            <Card>
              <CardHeader>
          ...
          {canManageClientRights && (
            <TabsContent value="client-rights" className="space-y-4">
              <Card>
                <CardHeader>
                  <CardTitle>Client Rights</CardTitle>
                  <CardDescription>
                    Control which modules are available for each client/tenant
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="flex items-center gap-2 mb-4">
